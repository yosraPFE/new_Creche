...
e.sInstance,this.oApi._fnJsonString(i),e.iCookieDuration,e.sCookiePrefix,e.fnCookieCallback)},fnStateSaveParams:null,iCookieDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iScrollLoadGap:100,iTabIndex:0,oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Premier",sLast:"Dernier",sNext:"Suivant",sPrevious:"Precedent    "},sEmptyTable:"Table vide",sInfo:"Afficher _START_ a _END_ de  _TOTAL_ entities",
sInfoEmpty:"Afficher 0 à 0 de 0 entities",sInfoFiltered:"(filtrer a partir de _MAX_ total entities)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"Afficher _MENU_ ",sLoadingRecords:"Chargement...",sProcessing:"Processing...",sSearch:"Recherche:",sUrl:"",sZeroRecords:"Aucun enregistrements correspondants trouves"},oSearch:i.extend({},j.models.oSearch),sAjaxDataProp:"aaData",sAjaxSource:null,sCookiePrefix:"SpryMedia_DataTables_",sDom:"lfrtip",sPaginationType:"two_button",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET"};
