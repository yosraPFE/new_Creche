						...
						<div class="box col-md-12">
							<div class="box-inner">
								...
								<div class="box-content">
									...
									<f:form name="formulaire" action="affecterEnfantAClub" method="GET">
...
<% double sumClubsPlannings = 0; %>
									...
									<input value="${dernierPayment.remise}"  name="remise" id="remise" class="form-control" onkeyup ="calculRemise()"/>
									
									</pre>
										
											<pre class="prettyprint linenums"><strong><font color="#8C001A">Total Par Mois :</font></strong>
									
									<input   name="somme" class="form-control" /></pre>
									<% sumClubsPlannings += Double.parseDouble(pageContext.getAttribute("prixTarifMoi").toString());%>
									<script type="text/javascript">
