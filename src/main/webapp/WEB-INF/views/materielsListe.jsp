								...
								<c:forEach items="${materiels}" var="m">
									<tr>
										...
										<td><a class="btn btn-success" title="Afficher Details"
											...
											title="Modifier Materiel" data-toggle="tooltip"
											href="modifierListeMateriels?idMat=${m.idMateriel}"
											onclick="modifierListeMateriels?idMat=${m.idMateriel}">
												<i class="glyphicon glyphicon-edit icon-white"></i>

										</a> <a class="btn btn-danger"
											title="Supprimer Materiel"
											data-toggle="tooltip"
											href="supprimerListeMateriels?idMat=${m.idMateriel}"
											onclick="return confirm('Êtes-vous sûr de vouloir supprimer ${m.designation} ?');">
