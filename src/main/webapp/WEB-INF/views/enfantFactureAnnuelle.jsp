                            ...
                            <div class="panel panel-default">
                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td>
                                            <h2 style="color:#ec6a97">Facture Annuelle </h2>
                                ...
                                <blockquote>
									...
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										...
										<blockquote>
                                    <p>${enfant.nom} ${enfant.prenom} a pour  Tarif d'Inscription Annuel ${crecheAnnee.tarifInscription} (DT) ,  Tarif d'Assurance Annuel ${crecheAnnee.tarifAssurance} (DT) et  Tarif du 1er Mois d'inscription ${crecheAnnee.tarifParMois} (DT) et
                                    suivant ces integrations dans dans les clubs et les plannings horraires choisis , il a pour montant sans remise ${payementAnnuelle.montantAvantRemise} (DT) et en affectant un  remise de ${payementAnnuelle.remise} % il a comme montant total ${payementAnnuelle.montantApresRemise} (Dt) . </p>
                                    
                                    <p>Type de paiement : "${payementAnnuelle.typePayement}" </p>
