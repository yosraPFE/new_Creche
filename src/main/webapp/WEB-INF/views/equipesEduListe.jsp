...
<title>Liste Equipe Educatif</title>
</head>
								...
								<c:forEach items="${equipeEducatifs}" var="EqEdu">
									<tr>
										...
										<td><a class="btn btn-success" title="Afficher Details"
											...
											title="Modifier Membre Equipe Educatif" data-toggle="tooltip"
											href="modifierListeEquipeEducatif?idEquipeEducatif=${EqEdu.idPerson}"
											onclick="modifierListeEquipeEducatif?idEquipeEducatif=${EqEdu.idPerson}">
												<i class="glyphicon glyphicon-edit icon-white"></i>

										</a> <a class="btn btn-danger"
											title="Supprimer Membre Equipe Educatif"
											data-toggle="tooltip"
											href="supprimerListeEquipeEducatif?idEquipeEducatif=${EqEdu.idPerson}"
											onclick="return confirm('Êtes-vous sûr de vouloir supprimer ${EqEdu.nom} ${EqEdu.prenom} ?');">
										...
										<a  class="btn btn-warning" title="Affecter à une classe"
											data-toggle="tooltip" href="<c:url value="/adminEqCla/choisirClasses?idEquiEducatif=${EqEdu.idPerson}"/>">
										...
										<a  class="btn btn-success" title="Affecter à une categorie"
											data-toggle="tooltip" href="<c:url value="/adminEqCateg/choisirCategorieClub?idEquiEducatif=${EqEdu.idPerson}"/>">
										...
										<a  class="btn btn-success" title="Affecter materiels"
											data-toggle="tooltip" href="<c:url value="/adminEqMater/choisirMateriles?idEquiEducatif=${EqEdu.idPerson}"/>">
