...
@Controller
@RequestMapping(value = "/adminEduCategEq")
public class EquipeEducatifCategorieAdminController implements HandlerExceptionResolver
{
	/**
	 * 
	 * @author YOSRA
	...
	public String index(Model model) {
		...
		return "EquipeEducatifCategorie";
	...
	public ModelAndView resolveException(HttpServletRequest request,
		...
		mv.setViewName("EquipeEducatifCategorie");
		return mv;
	}
