...
@Controller
@RequestMapping(value = "/adminEduMateriel")
public class EquipeEducatifMaterielAdminController implements HandlerExceptionResolver
{
	/**
	 * 
	 * @author YOSRA
	...
	public ModelAndView resolveException(HttpServletRequest request,
		...
		mv.setViewName("EquipeEducatifMateril");
		return mv;
	}
