...
@Controller
@RequestMapping(value = "/adminEnfConsulta")
public class EnfantConsultationAdminController implements HandlerExceptionResolver
{
	/**
	 * 
	 * @author YOSRA
...
/*
	...
	public ModelAndView resolveException(HttpServletRequest request,
		...
		mv.setViewName("EnfantConsultation");
		return mv;
	}
